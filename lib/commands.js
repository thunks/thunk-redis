...
exports.initCommands = function (proto) {
  ...
  proto.mset = function (hash) {
    var args = (typeof hash === 'object') ? toArray(hash, []) : tool.slice(arguments);
  ...
  proto.hmset = function (key, hash) {
    var args = (typeof hash === 'object') ? toArray(hash, [key]) : tool.slice(arguments);
